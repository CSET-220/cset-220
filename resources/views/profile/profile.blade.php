...
{{-- <div class="mx-auto w-full"> --}}
    <div class="flex justify-around flex-col sm:flex-wrap sm:flex-row p-8 pt-8 sm:pb-20 sm:w-full flex-grow">
        ...
        <div class="flex flex-col mr-0 mb-4 w-full md:w-1/3 md:mr-6 flex-grow relative">
            ...
            {{-- Bottom Left --}}
            <div class="bg-gray-200 p-4 lg:p-4 rounded-lg shadow-gray-600 shadow-md w-full flex-grow flex flex-col justify-around">
        ...
        <div class="flex flex-col justify-between ml-0 mb-4 w-full md:w-3/5 md:ml-6 flex-grow">
            ...
            {{-- Bottom Right --}}
            <div class="bg-gray-200 p-4 pt-2 rounded-lg shadow-gray-600 shadow-md flex-grow flex flex-col justify-between">
                @if (Auth::user()->getAccess(['patient']))
