    ...
    @else
        ...
        <div class="flex justify-center my-2">
            @foreach ($family as $fam)
                ...
                <div data-popover-target="popover-patient-caregiver" class=" cursor-pointer relative inline-flex items-center justify-center w-8 h-8 overflow-hidden rounded-full bg-blue-600 hover:shadow-md">
                    <span class="font-medium text-gray-300">{{ $initials }}</span>
                </div>
        
                <div data-popover id="popover-patient-caregiver" role="tooltip" class="absolute z-10 invisible inline-block w-64 text-sm text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 dark:text-gray-400 dark:bg-gray-800 dark:border-gray-600">
                    <div class="p-3">
                        ...
                        <p class="text-base font-semibold leading-none text-gray-900 dark:text-white">
                            <a href="#">{{ $fam->full_name }}</a>
                        </p>
                        <p class="mb-3 text-sm font-normal">
                            <a class="hover:underline">{{ $fam->email }}</a>
                        </p>
                        <p class="mb-4 text-sm">Contact: <a href="#" class="text-blue-600 dark:text-blue-500 hover:underline">{{ $fam->phone }}</a>.</p>
