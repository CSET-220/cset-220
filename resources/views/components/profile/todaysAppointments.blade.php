<div>
    ...
    <div class="p-2 pb-4 rounded-sm">
        <div class="flex items-center space-x-2 font-semibold text-gray-900 leading-8">
            ...
            <span class="tracking-wide">Today's Appointments</span>
        </div>
    </div>
    <ol class="items-center sm:flex justify-center">
        @if(count($allApts) < 1)
            <p class="text-center">No Appointments Today</p>
        @else
            @foreach ($allApts as $apt)
                <li class="relative mb-6 sm:mb-0">
                    ...
                    <div class="mt-3 sm:pe-8">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Dr. {{ $apt->doctor->last_name }}</h3>
