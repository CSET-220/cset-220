<div>
    ...
    <div id="patient_log" class="pt-2">
        <form action="{{ route('family.dashboard.connect', ['user' =>Auth::user()]) }}" method="GET" id="fam_code_form">   
            ...
            <div class="relative">
                ...
                <div class="relative z-0">
                    <input type="text" id="fam_code_search" data-family-id="{{ Auth::id() }}" name="fam_code_search" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                ...
                <button type="submit" id="fam_code_search_btn" class="text-white absolute end-2.5 bottom-1.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
            </div>
        </form>
    </div>
</div>