...
@section('mainContent')
    ...
    <form method="POST" action="{{route('admin.updatePatientInfo')}}" class="w-1/4 mx-auto mb-20 relative p-4 overflow-x-auto">
        ...
        <select required name="patient_group" id="patient_group" class="mb-5 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
